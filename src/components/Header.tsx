...
export default function Header() {
    ...
    return (
        <header className="lg:col-span-5 lg:sticky lg:top-0 lg:flex lg:h-screen lg:flex-col lg:justify-start lg:py-20 lg:gap-8 pt-16 pb-8 lg:overflow-y-auto scrollbar-hidden">
            <div>
            ...
            <div className="flex items-center gap-5 mt-6 lg:mt-0">
                ...
                <a href="https://github.com/itxmjr" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-[#00FF7F] transition-all duration-300 hover:drop-shadow-[0_0_8px_rgba(45,227,184,0.5)] hover:-translate-y-0.5">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="-1 -1 26 26" fill="currentColor" style={{ overflow: 'visible' }}>
                ...
                <a href="https://fiverr.com/aibymjr" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-[#00FF7F] transition-all duration-300 hover:drop-shadow-[0_0_8px_rgba(45,227,184,0.5)] hover:-translate-y-0.5">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M5 22V13H3V11H5V8.5C5 5.46 7.46 3 10.5 3H12V5H10.5C8.57 5 7 6.57 7 8.5V11H11V13H7V22H5Z"/>
                        <circle cx="16" cy="4.5" r="1.5"/>
                        <rect x="14.75" y="9" width="2.5" height="13" rx="1.25"/>
                    </svg>
                </a>
